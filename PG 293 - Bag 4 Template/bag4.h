...
{
	//Change 1: include template class prefix 
	//Change 2: replace int with Item
	...
	public:
		...
		typedef std::size_t size_type;	//????????????WHY NOT IN TEMPLATE PREFIX INCLUDE ITEM, AND SIZETYPE, AND THEN REPLACE SIZE_T??????????????
	...
	//Outside class definition, all mem/nonmem fns get template prefix and bag changes to bag<item>
...
#include "bag4.cpp"  // Include the implementation
#endif
*/